...
const AdminTermsConditions = () => {
    ...
    return (
        <div className="p-8 animate-fade-in max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold font-display mb-2">Terms & Conditions</h1>
            <p className="text-muted-foreground mb-8">Edit the Terms & Conditions page content. Changes will appear on the public site. Use links in the editor for internal pages (e.g. Privacy Policy).</p>
            ...
            <form onSubmit={handleSubmit}>
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Title and body shown on the Terms & Conditions page. Toolbar: headers, bold, lists, link, color, align, code block. Use the HTML tab to edit or paste raw HTML.</CardDescription>
                    </CardHeader>
