...
const AdminDashboard = () => {
    ...
    // Default Layout for Admin and Subadmin
    return (
        <div className="space-y-8 animate-fade-in pb-10">
            {/* Header */}
            <div className={`bg-gradient-to-r ${isSuperAdmin ? 'from-gray-900 to-gray-800' : 'from-blue-900 to-indigo-800'} p-8 rounded-2xl text-white shadow-xl`}>
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-4xl font-display font-bold mb-2">
                            {isSuperAdmin ? "Super Admin Control Center" : "Subadmin Portal"}
                        </h1>
                        <p className={isSuperAdmin ? "text-gray-400" : "text-blue-100/80"}>
                            {isSuperAdmin ? "Welcome back. You have full system access." : "Welcome back. Monitor user registrations and system metrics in real-time."}
                        </p>
                    </div>
                    {isSuperAdmin && (
            ...
            {/* Added styling to table, same as bottom subadmin section */}
